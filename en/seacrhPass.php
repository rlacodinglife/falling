        ...
        <nav class="top_nav">
            ...
            <ul class="top_ul login_btn">
                ...
                <li class="lang">
                    ...
                    <p>|</p>
                    <p><a href="./seacrhPass.php">ENG</a></p>
                </li>
        ...
        <section id="main">
            <div id="wrap" class="wrapper">
                <form method="post" name="join" id="join">
                    ...
                    <div id="container">
                        <div class="row_group">
                            ...
                            <div class="userInput">
                                <!-- 비밀번호 입력 -->
                                <h3 class="list">Date of birth<span id="pwError"></span></h3>
                                <span class="box int_id"><input type="date" id="date" class="int check"
                                        placeholder="" maxlength="2999-99-99"></span>
                            </div>
                            <!-- 비밀번호 재확인 입력 -->
                ...
                <div class="Pop_alert able">
                    <p class="bold">Find Password</p>
                    <p class="normal">Your temporary password is <span class="Pop_span">asdasdasd</span> <br> Please make changes after logging in.</p>
                    <div class="Pop_btn">
                        <button class="btn_style cancle"><a href="./login.php">Go to Login</a></button>
                        <button class="btn_style login"><a href="./seacrhPass.php">Cancel</a></button>
                    </div>
                </div>
                ...
                <div class="Pop_alert unable">
                    ...
                    <p class="normal">Membership information does
                        not exist.</p>
                    <div class="Pop_btn">
                        <button class="btn_style"><a href="./register.php">Go to sign up</a></button>
